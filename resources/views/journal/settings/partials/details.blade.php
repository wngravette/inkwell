...
<script>
    $(document).ready( function() {
        ...
        $('.menu-item.details').addClass('selected');
    });
</script>
@endsection
...
<form>
    <dl class="form">
        <dt><label>First & Last Name</label></dt>
        <dd class="half-inputs"><input class="one-half" type="text" placeholder="First name" value="{{Auth::user()->first_name}}"></dd>
    </dl>
    <dl class="form">
        <dd class="half-inputs"><input type="text" placeholder="Last name" value="{{Auth::user()->last_name}}"></dd>
    </dl>
    <dl class="form">
        <dt><label>Email Adress</label></dt>
        <dd class="half-inputs"><input class="one-half" type="text" placeholder="First name" value="{{Auth::user()->email}}"></dd>
    </dl>
    <dl class="form">
        <dt><label>Your Timezone</label></dt>
        <dd>
            <p>
                We have your time-zone set as <strong>Melbourne/Australia</strong>.
            </p>
            <!--
            <select class="select full-width" id="timezone" name="timezone">
    ...
    <div class="form-checkbox">
        ...
        <p class="note">
        Get an email every evening reminding you to write something for that day!
        </p>
    </div>
</form>
@endsection
