...
a,.wrapper li a{color:#4eaacc}.wrapper h1 a:hover,.wrapper h2 a:hover,.wrapper h3 a:hover,.wrapper p a:hover,.wrapper li a:hover{text-decoration:none}.wrapper .btn a{background-color:#4eaacc;color:#fff}.wrapper .btn a:hover{color:#fff !important}.logo div{color:#38434d}.logo div a{color:#38434d}.logo div a:hover{color:#38434d !important}.header,.footer .inner td{color:gray}.wrapper .header a,.wrapper .footer a{color:gray}.wrapper .header a:hover,.wrapper .footer a:hover{color:#5a5a5a !important}.column-bg{background-color:#fff}.image-frame{background-color:#fff;border-color:#f2efe9}.preheader{background-color:#ededf1}.preheader .title,.preheader .webversion{color:gray}.preheader .title a,.preheader .webversion a{color:gray}.preheader .title a:hover,.preheader .webversion a:hover{color:#5a5a5a !important}.divider{background-color:#cbcbd7}.one-col blockquote{border-left:4px solid
#cbcbd7}.two-col blockquote,.narrower blockquote,.three-col blockquote{border-left:2px solid #cbcbd7}.one-col-feature blockquote p:first-child{border-top:1px solid #cbcbd7}.one-col-feature blockquote p:last-child{border-bottom:1px solid #cbcbd7}td.border{background-color:#f6f6f8}.emb-editor-canvas{background-color:#ededf1}@media (min-width:0){body{background-color:#ededf1}}.wrapper .footer .fblike,.wrapper .footer .tweet,.wrapper .footer .linkedinshare,.wrapper .footer .forwardtoafriend{background-color:#7b7b7c}
</style><!--[if mso]>
<style type="text/css">
@import url(https://fonts.googleapis.com/css?family=Cabin:400,700,400italic,700italic|PT+Serif:400,700,400italic,700italic|Ubuntu:400,700,400italic,700italic);
</style>
    ...
    <center class="wrapper" style="display: table;table-layout: fixed;width: 100%;min-width: 620px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;background-color: #f6f6f8">
              ...
              <table class="full-width centered" style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto;width: 600px;margin: 0 auto">
                <tbody><tr>
                  <td class="title column" style="padding: 0;vertical-align: middle;text-align: left;font-family: Ubuntu,sans-serif;font-size: 10px;line-height: 16px;letter-spacing: 0.01em;text-decoration: none;width: 385px;color: gray">
                    <div>Please verify your Inkwell account.</div>
                  </td>
      ...
      <div class="spacer" style="font-size: 1px;line-height: 20px;width: 100%">&nbsp;</div>
          ...
          <table class="one-col-bg" style="border-collapse: collapse;border-spacing: 0;width: 100%">
            ...
            <h1 style="font-style: normal;font-weight: 400;Margin-bottom: 18px;Margin-top: 0;font-size: 22px;line-height: 30px;font-family: Ubuntu,sans-serif;color: #3e4751">Inkwell&nbsp;<span style="color:#b0b0b0">/ {{$title}}</span></h1>
            ...
            <p style="font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 0;font-size: 13px;line-height: 22px;font-family: Cabin,Avenir,sans-serif;color: #7c7e7f">Happy writing,<br />
William, Inkwell</p>
        ...
        <tbody><tr>
          ...
          <td class="inner" style="padding: 58px 0 29px 0;vertical-align: middle;width: 600px">
            ...
            <table class="left" style="border-collapse: collapse;border-spacing: 0" align="left">
              <tbody><tr>
                <td style="padding: 0;vertical-align: middle;color: gray;font-size: 12px;line-height: 22px;text-align: left;width: 400px">

                  <div class="address" style="font-family: Ubuntu,sans-serif;Margin-bottom: 18px">
                    <div>Inkwell.<br />
Built in Melbourne, Australia</div>
                  </div>
